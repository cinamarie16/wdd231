export const interests = [
    {
        "img": "images/dreamwalk.webp",
        "name": "Dreamwalk Park",
        "address": {
            "street" : "575 E University Pkwy, Suite N- 237",
            "city" : "Orem, UT 84097"
        },
        "description": "Your gateway from the ordinary to the extraordinary! Step through the Dreamwalk Portal and discover worlds you've only dreamed of. The nearly half-mile of pathways will take you through many stunning, other-worldly landscapes to enjoy and interact with."
    },
    {
        "img": "images/all-together.webp",
    ...
    },
    {
        ...
        "address": {
            "street": "1931 S. Sandhill Rd",
            "city": "Orem, UT 84058"
        },
        "description": "Nielsen's Grove is the oldest park in Utah. The park was started in 1880 by Danish immigrant Jorgen Nielsen. The park is the only park with a water feature and contains many design elements found in European castle gardens."
    },
    {
        "img": "images/hangtime.webp",
        "name": "Hangtime Adventure Park",
        "address": {
    ...
    },
    {
        ...
        "name": "Orem Family Fitness Center",
        "address": {
            "street": "575 W Center St",
            "city": "Orem, UT 84057"
        },
        "description": "Fitness center, indoor swimming pool, indoor playground, teen lounge, drop-in sports, and classes."
    }
